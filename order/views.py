...
#创建AliPay对象
alipay = AliPay(appid='2021000117616622', app_notify_url='http://127.0.0.1:8000/order/checkPay/', app_private_key_path='order/keys/my_private_key.txt',
...
class ToPayView(View):
    def get(self,request):
        ...
        orderItemList = [getCartManger(request).get_cartitems(**item) for item in cartitems if item]
        totalPrice = 0
